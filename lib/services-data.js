...
const serviceIconOverrides = {
  "tarot-reading": "tarot",
  "energy-healing": "sparkles",
  "manifestation-coaching": "sun",
  "soul-guidance": "lotus",
  "love-relationship": "heart",
  "general-guidance": "eye",
  "career-finance": "briefcase",
  "detailed-life-path": "star",
  "will-they-come-back": "heart",
  "future-spouse-marriage-timing": "star",
  "the-connection-truth": "eye",
  "karmic-contracts": "key",
  "money-block-decoder": "briefcase",
  "the-blockage-behind-the-blockage": "sparkles",
  "lunar-release": "moon",
  "mirror-reclaim": "eye",
  "cord-unbound": "key",
  "unspoken": "heart",
  "aura-veil": "sparkles",
  "rose-rebirth": "lotus",
  "ember-restoration": "flame",
  "venus-renewal": "heart",
  "crown-awakening": "star",
  "golden-current": "sun",
  "doorway-clearing": "key",
  "ancestral-release": "moon",
  "beyond-the-veil": "eye",
  "destiny-reset": "sun",
  "rebirth-code": "sparkles",
  "intentional-spellwork": "flame",
  "custom-soulmirror-session": "key",
};

export const services = [...baseServices, ...catalogueServices].map((service) => ({
  ...service,
  icon: serviceIconOverrides[service.slug] || service.icon,
}));
