...
const serviceImageData = {
  "tarot-reading": { lightImage: "/images/tarot_reading_service.png", darkImage: "/images/tarot_reading_dark_service.png", imageAlt: "Tarot cards, candle and crystals" },
  "energy-healing": { lightImage: "/images/energy_healing_service.png", darkImage: "/images/energy_healing_dark_service.png", imageAlt: "Crystal energy healing illustration" },
  "manifestation-coaching": { lightImage: "/images/manifestation_coaching_service.png", darkImage: "/images/manifestation_coaching_dark_service.png", imageAlt: "Moon and stars manifestation illustration" },
  "soul-guidance": { lightImage: "/images/soul_guidance_service.png", darkImage: "/images/soul_guidance_dark_service.png", imageAlt: "Lotus soul guidance illustration" },
  "love-relationship": { lightImage: "/images/love_relationship_guidance_service.png", darkImage: "/images/love_relationship_guidance_dark_service.png", imageAlt: "Love and relationship guidance illustration" },
  "custom-session": { lightImage: "/images/custom_session_service.png", darkImage: "/images/custom_session_dark_service.png", imageAlt: "Custom spiritual session illustration" },
  "general-guidance": { lightImage: "/images/general_guidance_session_service.png", darkImage: "/images/general_guidance_session_dark_service.png", imageAlt: "General guidance tarot illustration" },
  "career-finance": { lightImage: "/images/career_finance_reading_service.png", darkImage: "/images/career_finance_reading_dark_service.png", imageAlt: "Career and finance tarot illustration" },
  "detailed-life-path": { lightImage: "/images/detailed_life_path_service.png", darkImage: "/images/detailed_life_path_dark_service.png", imageAlt: "Detailed life path tarot illustration" },
  "will-they-come-back": { lightImage: "/images/will_they _come_back_service.png", darkImage: "/images/will_they _come_back_dark_service.png", imageAlt: "Will they come back tarot illustration" },
  "future-spouse-marriage-timing": { lightImage: "/images/future_spouse_marriage_service.png", darkImage: "/images/future_spouse_marriage_dark_service.png", imageAlt: "Future spouse marriage tarot illustration" },
  "the-connection-truth": { lightImage: "/images/connection_truth_service.png", darkImage: "/images/connection_truth_dark_service.png", imageAlt: "Connection truth tarot illustration" },
  "karmic-contracts": { lightImage: "/images/karmic_contracts_service.png", darkImage: "/images/karmic_contracts_dark_service.png", imageAlt: "Karmic contracts tarot illustration" },
  "money-block-decoder": { lightImage: "/images/money_blocker_service.png", darkImage: "/images/money_blocker_dark_service.png", imageAlt: "Money block decoder illustration" },
  "the-blockage-behind-the-blockage": { lightImage: "/images/blockage_behind_blockage_service.png", darkImage: "/images/blockage_behind_blockage_dark_service.png", imageAlt: "Blockage behind blockage healing illustration" },
  "lunar-release": { lightImage: "/images/lunar_release_service.png", darkImage: "/images/lunar_release_dark_service.png", imageAlt: "Lunar release healing illustration" },
  "mirror-reclaim": { lightImage: "/images/mirror_reclaim_service.png", darkImage: "/images/mirror_reclaim_dark_service.png", imageAlt: "Mirror reclaim healing illustration" },
  "cord-unbound": { lightImage: "/images/cord_unbound_service.png", darkImage: "/images/cord_unbound_dark_service.png", imageAlt: "Cord unbound healing illustration" },
  "unspoken": { lightImage: "/images/unspoken_service.png?v=2", darkImage: "/images/unspoken_dark_service.png", imageAlt: "Unspoken healing illustration" },
  "aura-veil": { lightImage: "/images/aura_veil_service.png?v=2", darkImage: "/images/aura_veil_dark_service.png", imageAlt: "Aura veil healing illustration" },
  "rose-rebirth": { lightImage: "/images/rose_rebirth_service.png", darkImage: "/images/rose_rebirth_dark_service.png", imageAlt: "Rose rebirth healing illustration" },
  "ember-restoration": { lightImage: "/images/ember_restoration_service.png", darkImage: "/images/ember_restoration_dark_service.png", imageAlt: "Ember restoration healing illustration" },
  "venus-renewal": { lightImage: "/images/venus_renewal_service.png", darkImage: "/images/venus_renewal_dark_service.png", imageAlt: "Venus renewal healing illustration" },
  "crown-awakening": { lightImage: "/images/crown_awakening_service.png", darkImage: "/images/crown_awakening_dark_service.png", imageAlt: "Crown awakening healing illustration" },
  "golden-current": { lightImage: "/images/golden_current_service.png", darkImage: "/images/golden_current_dark_service.png", imageAlt: "Golden current healing illustration" },
  "doorway-clearing": { lightImage: "/images/doorway_cleaning_service.png", darkImage: "/images/doorway_cleaning_dark_service.png", imageAlt: "Doorway clearing healing illustration" },
  "ancestral-release": { lightImage: "/images/ancestral_release_service.png", darkImage: "/images/ancestral_release_dark_service.png", imageAlt: "Ancestral release healing illustration" },
  "beyond-the-veil": { lightImage: "/images/beyond_veil_service.png", darkImage: "/images/beyond_veil_dark_service.png", imageAlt: "Beyond the veil healing illustration" },
  "destiny-reset": { lightImage: "/images/destiny_reset_service.png", darkImage: "/images/destiny_reset_dark_service.png", imageAlt: "Destiny reset healing illustration" },
  "rebirth-code": { lightImage: "/images/rebirth_code_service.png", darkImage: "/images/rebirth_code_dark_service.png", imageAlt: "Rebirth code transformation illustration" },
  "intentional-spellwork": { lightImage: "/images/intentional_spellwork_service.png", darkImage: "/images/intentional_spellwork_dark_service.png", imageAlt: "Intentional spellwork illustration" },
  "custom-soulmirror-session": { lightImage: "/images/custom_soulmirror_session_service.png", darkImage: "/images/custom_soulmirror_session_dark_service.png", imageAlt: "Custom SoulMirror session illustration" },
};
...
export const services = [...baseServices, ...catalogueServices].map((service) => ({
  ...service,
  ...serviceImageData[service.slug],
  icon: serviceIconOverrides[service.slug] || service.icon,
}));

const manifestationIndex = services.findIndex((service) => service.slug === "manifestation-coaching");
const spellworkIndex = services.findIndex((service) => service.slug === "intentional-spellwork");
[services[manifestationIndex], services[spellworkIndex]] = [services[spellworkIndex], services[manifestationIndex]];
